...
//au lieu due la class AbstractType initiale pour créer des configurations rapides
class BookingType extends ApplicationType
{
    ...
    {
        //initialement, on avait mis tous les types Date en DatType, mais l'utilisation du bootstrap-datepicker les fait passer en TextType
        //De même dans ce cas, l'option widget n'existe plus donc on vire le tableau , ['widget'=>'single_text']
        $builder
