...
class Ad
{
     ...
     *
     * @return array Un tableau d'objets DateTime représentant les jours d'occcupation
     */
    ...
    public function getNotAvailableDays(){
        ...
        Foreach($this->bookings as $booking){
            ...
            $resultat = range($booking->getStartDate()->getTimestamp(),$booking->getEndDate()->getTimestamp(),14*60*60);
